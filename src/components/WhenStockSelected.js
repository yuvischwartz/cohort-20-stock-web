...
function WhenStockSelected(props) {
    ...
    <>
        <div className={'m-8'}>
          <h1>{props.stockNameSelected}</h1>
            <h2>You have {props.stockQuantitySelected} shares at {props.stockPriceSelected}.00 per share.</h2>
